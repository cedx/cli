...
public class RootCommand: System.CommandLine.RootCommand {
	...
	public RootCommand(IconvCommand iconv, MySqlCommand mysql, NssmCommand nssm, SetupCommand setup): base("Command line interface of Cédric Belin, full stack developer.") {
