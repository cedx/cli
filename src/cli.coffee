...
Commands:
	db-backup [options] <directory>         Backup a set of MariaDB/MySQL tables.
	db-charset [options] <collation>        Alter the character set of MariaDB/MySQL tables.
	db-engine [options] <engine>            Alter the storage engine of MariaDB/MySQL tables.
	db-optimize [options]                   Optimize a set of MariaDB/MySQL tables.
	db-restore [options] <fileOrDirectory>  Restore a set of MariaDB/MySQL tables.
